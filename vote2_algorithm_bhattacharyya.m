function [ vote_matrix_bhattacharyya_helix,remove_helix_bhattacharyya,remove_stick_bhattacharyya ] = vote_algorithm_bhattacharyya(index_angle_bhattacharyya,index_deltaLength_bhattacharyya,index_Euclidean_bhattacharyya);
...
for i=1:size1(2)
    if ((index_deltaLength_bhattacharyya(i).num_helix==index_angle_bhattacharyya(i).num_helix) && (index_deltaLength_bhattacharyya(i).num_stick==index_angle_bhattacharyya(i).num_stick))|| ((index_deltaLength_bhattacharyya(i).num_helix==index_Euclidean_bhattacharyya(i).num_helix) && (index_deltaLength_bhattacharyya(i).num_stick==index_Euclidean_bhattacharyya(i).num_stick)); 
       c=ismember(index_deltaLength_bhattacharyya(i).num_helix,vote_matrix_bhattacharyya_helix); 
       if c==0
        vote_matrix_bhattacharyya_helix=[vote_matrix_bhattacharyya_helix  index_deltaLength_bhattacharyya(i).num_helix];
        vote_matrix_bhattacharyya_stick=[vote_matrix_bhattacharyya_stick  index_deltaLength_bhattacharyya(i).num_stick];
       end
    end
end
