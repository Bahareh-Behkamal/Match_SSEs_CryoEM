function [reduced_angle_helix_bhat,reduced_deltaLength_helix_bhat,reduced_Euclidean_helix_bhat ] = compute_reduce_helix_bhat(remove_helix_bhat,helix_number,angle_helix,deltaLength_helix,Euclidean_helix)


L=length(remove_helix_bhat);
...
for i=1:helix_number
    ...
    for j=1:L 
        ...
        if angle_helix(i,1)==remove_helix_bhat(j)
            flag=true;
            break;
        end
    end      
...
for j=1:helix_number
    ...
    for k=1:L 
        ...
        if angle_helix(1,j)==remove_helix_bhat(k)  
            flag=true;
            break;
        end
    end      
...
reduced_angle_helix_bhat=reduced_column_angle_helix;
...
for i=1:helix_number
    ...
    for j=1:L 
        ...
        if deltaLength_helix(i,1)==remove_helix_bhat(j)
            flag=true;
            break;
        end
    end      
...
for j=1:helix_number
    ...
    for k=1:L 
        ...
        if deltaLength_helix(1,j)==remove_helix_bhat(k)
            flag=true;
            break;
        end
    end      
...
reduced_deltaLength_helix_bhat=reduced_column_deltaLength_helix;
...
for i=1:helix_number
    ...
    for j=1:L 
        ...
        if Euclidean_helix(i,1)==remove_helix_bhat(j) 
            flag=true;
            break;
        end
    end      
...
for j=1:helix_number
    ...
    for k=1:L 
        ...
        if Euclidean_helix(1,j)==remove_helix_bhat(k)  
            flag=true;
            break;
        end
    end      
...
reduced_Euclidean_helix_bhat=reduced_column_Euclidean_helix;
