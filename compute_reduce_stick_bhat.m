function [reduced_angle_stick_bhat,reduced_deltaLength_stick_bhat,reduced_Euclidean_stick_bhat ] =compute_reduce_stick_bhat(remove_stick_bhat,stick_number,angle_stick,deltaLength_stick,Euclidean_stick)


L=length(remove_stick_bhat);
...
for i=1:stick_number
    ...
    for j=1:L 
        ...
        if angle_stick(i,1)==remove_stick_bhat(j)
            flag=true;
            break;
        end
    end      
...
for j=1:stick_number
    ...
    for k=1:L 
        ...
        if angle_stick(1,j)==remove_stick_bhat(k)  
            flag=true;
            break;
        end
    end      
...
reduced_angle_stick_bhat=reduced_column_angle_stick;
...
for i=1:stick_number
    ...
    for j=1:L 
        ...
        if deltaLength_stick(i,1)==remove_stick_bhat(j)
            flag=true;
            break;
        end
    end      
...
for j=1:stick_number
    ...
    for k=1:L 
        ...
        if deltaLength_stick(1,j)==remove_stick_bhat(k)
            flag=true;
            break;
        end
    end      
...
reduced_deltaLength_stick_bhat=reduced_column_deltaLength_stick;
...
for i=1:stick_number
    ...
    for j=1:L 
        ...
        if Euclidean_stick(i,1)==remove_stick_bhat(j) 
            flag=true;
            break;
        end
    end      
...
for j=1:stick_number
    ...
    for k=1:L 
        ...
        if Euclidean_stick(1,j)==remove_stick_bhat(k)  
            flag=true;
            break;
        end
    end      
...
reduced_Euclidean_stick_bhat=reduced_column_Euclidean_stick;
