...
switch(Protein_ID)
    ...
    case 1     % #Helices=5     #Sticks=5
        protein_data(Protein_ID).name='1BZ4.PDB';
    ...
    case 2    % #Helices=7   #Sticks=7
        protein_data(Protein_ID).name='1FLP.PDB';
    ...
    case 3  % #Helices=6   #Strands=2  #Stick-Helices=6   #Stick-Strands=2
        protein_data(Protein_ID).name='2Y4Z.PDB';
    ...
    case 4     % #Helices=9   #Sticks=7
        protein_data(Protein_ID).name='1NG6.PDB';
    ...
    case 5      % #Helices=11     #Sticks=9
        ...
        protein_data(Protein_ID).name='1HG5.PDB';
    ...
    case 6    % #Helices=11   #Sticks=7
        ...
        protein_data(Protein_ID).name='3HBE.PDB';
        protein_data(Protein_ID).stick_hlces='3HBE_Stick_hlces.csv';
        protein_data(Protein_ID).chain='X'
    ...
    case 7      % #Helices=13   #Sticks=9
        ...
        protein_data(Protein_ID).name='1P5X.PDB';
    ...
    case 8      % #Helices=13     #Sticks=9
        protein_data(Protein_ID).name='2XB5.PDB';
    ...
    case 9    % #Helices=6    #Strands=7  #Stick-Helices=4   #Stick-Strands=7
        protein_data(Protein_ID).name='1ICX.PDB';
    ...
    case 10    % #Helices=14   #Sticks=14
        ...
        protein_data(Protein_ID).name='1XQO.PDB';
    ...
    case 11      % #Helices=16   #Sticks=12
        protein_data(Protein_ID).name='3LTJ.PDB';
    ...
    case 12      % #Helices=17     #Sticks=14
        protein_data(Protein_ID).name='3ACW.PDB';
    ...
    case 13       % #Helices=20     #Sticks=20
        protein_data(Protein_ID).name='3HJL.PDB';
    ...
    case 14       % #Helices=21     #Sticks=16
        protein_data(Protein_ID).name='3ODS.PDB';
    ...
    case 15   % #Helices=33 #Sticks=19
        ...
        protein_data(Protein_ID).name='2XVV.PDB';
...
% ************************* Experimental Data *****************************
    ...
    case 17    % #Helices=3   #Strands=8  #Stick-Helices=3   #Stick-Strands=6
        protein_data(Protein_ID).name='6EM3.PDB';
    ...
    case 18     % #Helices=9   #Strands=4  #Stick-Helices=6   #Stick-Strands=3
        protein_data(Protein_ID).name='5UZB.PDB';
    ...
    case 19     % #Helices=13     #Sticks=11
        protein_data(Protein_ID).name='6F36.PDB';
        protein_data(Protein_ID).stick_hlces='6F36_Stick_hlces.csv';
        protein_data(Protein_ID).chain='M'
    ...
    case 20    % #Helices=8   #Strands=10  #Stick-Helices=6   #Stick-Strands=9
        protein_data(Protein_ID).name='3C91.PDB';
    ...
    case 21     % #Helices=19     #Sticks=17
        protein_data(Protein_ID).name='5I1M.PDB';
        protein_data(Protein_ID).stick_hlces='5I1M_Stick_hlces.csv';
        protein_data(Protein_ID).chain='V'
    ...
    case 22     % #Helices=15   #Strands=8  #Stick-Helices=15   #Stick-Strands=7
        protein_data(Protein_ID).name='4CHV.PDB';
    ...
    case 23    %#Helices=3   #Strands=21  #Stick-Helices=3   #Stick-Strands=19
        protein_data(Protein_ID).name='5O8O.PDB';
    ...
    case 24   %%#Helices=33   #Strands=10  #Stick-Helices=27   #Stick_Strands=8
        protein_data(Protein_ID).name='6UXW.PDB';
    ...
    case 25     %#Helices=33   #Strands=32  #Stick-Helices=28   #Stick_Strands=26
        protein_data(Protein_ID).name='5KBU.PDB';
...
if helix_info==1
    ...
    [ matrix_angle_mac,unassign_angle_mac,match_angle_mac,nmiscore_angle_mac,accurateScore_angle_mac,NetFmeasure_angle_mac,recall_angle_mac,precision_angle_mac,Fmeasure_angle_mac,indF_angle_mac] = evaluate(topology_file_vector,final_angle_mac_vector)
    [ matrix_deltaLength_mac,unassign_deltaLength_mac,match_deltaLength_mac,nmiscore_deltaLength_mac,accurateScore_deltaLength_mac,NetFmeasure_deltaLength_mac,recall_deltaLength_mac,precision_deltaLength_mac,Fmeasure_deltaLength_mac,indF_deltaLength_mac] = evaluate(topology_file_vector,final_deltaLength_mac_vector)
    [ matrix_Euclidean_mac,unassign_Euclidean_mac,match_Euclidean_mac,nmiscore_Euclidean_mac,accurateScore_Euclidean_mac,NetFmeasure_Euclidean_mac,recall_Euclidean_mac,precision_Euclidean_mac,Fmeasure_Euclidean_mac,indF_Euclidean_mac] = evaluate(topology_file_vector,final_Euclidean_mac_vector)
    ...
    [ matrix_angle_bhat,unassign_angle_bhat,match_angle_bhat,nmiscore_angle_bhat,accurateScore_angle_bhat,NetFmeasure_angle_bhat,recall_angle_bhat,precision_angle_bhat,Fmeasure_angle_bhat,indF_angle_bhat] = evaluate(topology_file_vector,final_angle_bhat_vector)
    [ matrix_deltaLength_bhat,unassign_deltaLength_bhat,match_deltaLength_bhat,nmiscore_deltaLength_bhat,accurateScore_deltaLength_bhat,NetFmeasure_deltaLength_bhat,recall_deltaLength_bhat,precision_deltaLength_bhat,Fmeasure_deltaLength_bhat,indF_deltaLength_bhat] = evaluate(topology_file_vector,final_deltaLength_bhat_vector)
    [ matrix_Euclidean_bhat,unassign_Euclidean_bhat,match_Euclidean_bhat,nmiscore_Euclidean_bhat,accurateScore_Euclidean_bhat,NetFmeasure_Euclidean_bhat,recall_Euclidean_bhat,precision_Euclidean_bhat,Fmeasure_Euclidean_bhat,indF_Euclidean_bhat] = evaluate(topology_file_vector,final_Euclidean_bhat_vector)
    ...
    [ matrix_RVA_mac,unassign_RVA_mac,match_RVA_mac,nmiscore_RVA_mac,accurateScore_RVA_mac,NetFmeasure_RVA_mac,recall_RVA_mac,precision_RVA_mac,Fmeasure_RVA_mac,indF_RVA_mac] = evaluate(topology_file_vector,final_correspondence_mac_vector)
    ...
    [ matrix_RVA_bhat,unassign_RVA_bhat,match_RVA_bhat,nmiscore_RVA_bhat,accurateScore_RVA_bhat,NetFmeasure_RVA_bhat,recall_RVA_bhat,precision_RVA_bhat,Fmeasure_RVA_bhat,indF_RVA_bhat] = evaluate(topology_file_vector,final_correspondence_bhat_vector)
...
if sheet_info==1
    ...
    [ matrix_angle_mac_strand,unassign_angle_mac_strand,match_angle_mac_strand,nmiscore_angle_mac_strand,accurateScore_angle_mac_strand,NetFmeasure_angle_mac_strand,recall_angle_mac_strand,precision_angle_mac_strand,Fmeasure_angle_mac_strand,indF_angle_mac_strand] = evaluate(topology_file_vector_strand,final_angle_mac_vector_strand)
    [ matrix_deltaLength_mac_strand,unassign_deltaLength_mac_strand,match_deltaLength_mac_strand,nmiscore_deltaLength_mac_strand,accurateScore_deltaLength_mac_strand,NetFmeasure_deltaLength_mac_strand,recall_deltaLength_mac_strand,precision_deltaLength_mac_strand,Fmeasure_deltaLength_mac_strand,indF_deltaLength_mac_strand] = evaluate(topology_file_vector_strand,final_deltaLength_mac_vector_strand)
    [ matrix_Euclidean_mac_strand,unassign_Euclidean_mac_strand,match_Euclidean_mac_strand,nmiscore_Euclidean_mac_strand,accurateScore_Euclidean_mac_strand,NetFmeasure_Euclidean_mac_strand,recall_Euclidean_mac_strand,precision_Euclidean_mac_strand,Fmeasure_Euclidean_mac_strand,indF_Euclidean_mac_strand] = evaluate(topology_file_vector_strand,final_Euclidean_mac_vector_strand)
    ...
    [ matrix_RVA_mac_strand,unassign_RVA_mac_strand,match_RVA_mac_strand,nmiscore_RVA_mac_strand,accurateScore_RVA_mac_strand,NetFmeasure_RVA_mac_strand,recall_RVA_mac_strand,precision_RVA_mac_strand,Fmeasure_RVA_mac_strand,indF_RVA_mac_strand] = evaluate(topology_file_vector_strand,final_correspondence_mac_vector_strand)
    ...
    [ matrix_RVA_bhat_strand,unassign_RVA_bhat_strand,match_RVA_bhat_strand,nmiscore_RVA_bhat_strand,accurateScore_RVA_bhat_strand,NetFmeasure_RVA_bhat_strand,recall_RVA_bhat_strand,precision_RVA_bhat_strand,Fmeasure_RVA_bhat_strand,indF_RVA_bhat_strand] = evaluate(topology_file_vector_strand,final_correspondence_bhat_vector_strand)
...
if helix_info==1
    ...
    disp ('Recall_RVA_bhat_helix:');
    disp (100*recall_RVA_bhat);
    ...
    disp ('Recall_RVA_mac_helix:');
    disp (100*recall_RVA_mac);
...
if sheet_info==1
    ...
    disp ('Recall_RVA_bhat_Sheet:');
    disp (100*recall_RVA_bhat_strand);
    ...
    disp ('Recall_RVA_mac_Sheet:');
    disp (100*recall_RVA_mac_strand);
...
if helix_info==1 && sheet_info==1
    ...
    recall_RVA_bhat_SSE=(recall_RVA_bhat+recall_RVA_bhat_strand)/2;
    ...
    recall_RVA_mac_SSE=(recall_RVA_mac+recall_RVA_mac_strand)/2;
    ...
    disp ('Recall_RVA_bhat_SSE:');
    disp (100*recall_RVA_bhat_SSE);
    ...
    disp ('Recall_RVA_mac_SSE:');
    disp (100*recall_RVA_mac_SSE);
